# VR Profile Data Model
This page describes to xAPI statement components that can be used when working with virtual reality and xAPI.
...
## Verbs
The following xAPI [verbs](https://github.com/adlnet/xAPI-Spec/blob/master/xAPI-Data.md#verb) are defined in this specification.

Name | IRI | Used With | Common Attributes | Description
--|--|--|--|--|
Intialized | http://adlnet.gov/expapi/verbs/initialized |  |  | Default CMI5 that the application has been [initialized](https://github.com/AICC/CMI-5_Spec_Current/blob/quartz/cmi5_spec.md#932-initialized)
Terminated | http://adlnet.gov/expapi/verbs/terminated |  |  | Default CMI5 that the application has been [teminated](https://github.com/AICC/CMI-5_Spec_Current/blob/quartz/cmi5_spec.md#938-terminated)
Session Start | http://adlnet.gov/expapi/verbs/launched |  |  | Default CMI5 that the application has been [launched](https://github.com/AICC/CMI-5_Spec_Current/blob/quartz/cmi5_spec.md#931-launched)
...
## Objects
The following xAPI [objects](https://github.com/adlnet/xAPI-Spec/blob/master/xAPI-Data.md#object) are defined in this specification.
...
World Object | http://xapiprofile.org/xapi/activities/motive.3d.worldObject |  |  | Represents a virtual object in the virtual world.

## Extensions / Values
The following xAPI [extensions & values](https://github.com/adlnet/xAPI-Spec/blob/master/xAPI-Data.md#miscext) are defined in this specification.
